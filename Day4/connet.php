...
if (isset($_POST["del"])) {
    ...
    // print_r($del);
    $result = $web->execute($del);
    if ($result == true) {
        echo "<script>
        window.location.href = 'http://localhost/ford/day4/connet.php';
   </script>";
    } else {
        echo "No Dele";
    }
...
if (isset($_POST["up"])) {
    ...
    // print_r($newphone);
    $result = $web->execute($update_phone);
    if ($result == true) {
        echo "<script>
        window.location.href = 'http://localhost/ford/day4/connet.php';
   </script>";
...
//            VALUES ('" . $username . "', '" . $password . "', '" . $c_id . "', '" . $email . "', '" . $fname . "', '" . $lname . "', '" . $address . "','" . $phone . "')";
    ...
    <tr>
        ...
        <th>Action</th>";
            for ($i = 0; $i < count($array_result); $i++) {
                ...
                echo $td = "<form method='POST' type='submit'><tr><td>" . $i + 1 . "</td>" .
