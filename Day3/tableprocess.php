...
if (isset($_POST["username"]) && $_POST["username"] == "") {
    ...
    check_reg($_POST, $validate);
    // echo json_encode($response);
    // write_log(json_encode($response));
    exit;
}

function check_reg($i, $validate)
{
...
//         @mysqli_query($conn, "set character_set_connection=utf8mb4");
        ...
        $sql_c_id = "SELECT email FROM db_table WHERE c_id = '$p_c_id';";
        ...
        $sql_in = "INSERT INTO db_table (username, password, c_id, email, fname, lname , address , phone) 
           VALUES ('" . $p_username . "', '" . md5($p_password) . "','" . $p_c_id . "' , '" . $p_email . "', '" . $p_fname . "', '" . $p_lname . "', '" . $web->escape_string($p_address) . "','" . $web->escape_string($p_phone) . "')";
